...
const App = () => {
  const { handleInputChange, rows, rate, addRow, delRow } =
  ...
  return (
    <div className="w-[95%] text-center">
      ...
      <Button
        className={`mt-4 p-2 bg-red-600 hover:bg-red-900 ml-2 text-white rounded print:hidden ${
          rows && rows.length === 1 ? " hidden" : ""
        }`}
        onClick={delRow}
